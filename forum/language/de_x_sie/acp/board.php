...
$lang = array_merge($lang, array(
	...
	'NEW_MEMBER_POST_LIMIT_EXPLAIN'	=> 'Neu registrierte Benutzer sind Mitglied der <em>Kürzlich registrierte Benutzer</em>-Gruppe, bis sie diese Zahl von Beiträgen erreicht haben. Sie können diese Gruppe nutzen, um für sie die Nutzung von Privaten Nachrichten zu unterbinden oder um eine Freigabe ihrer Beiträge erforderlich zu machen. <strong>Ein Wert von 0 deaktiviert diese Funktion.</strong>',
...
$lang = array_merge($lang, array(
	...
	'ACP_FEED_NEWS_EXPLAIN'				=> 'Gibt die ersten Beiträge aus diesen Foren aus. Wählen Sie keine Foren aus, um den News-Feed zu deaktivieren.<br />Wählen Sie mehrere Foren aus/ab, indem Sie beim Klicken die <samp>Strg</samp>-Taste drücken.',
...
$lang = array_merge($lang, array(
	'ACP_VC_SETTINGS_EXPLAIN'				=> 'Hier können Sie CAPTCHA-Plugins auswählen und konfigurieren, die verschiedene Möglichkeiten zur Unterbindung von Anmeldungen sogenannter Spam-Bots bieten.',
